        ...
        <form onSubmit={submitTask}>
            <div className='row g-2'>
                ...
                <div className='input-group'>
                    <span className="input-group-text border-dark bg-danger text-light" id='Date'>Date</span>
                    ...
                    <span className="input-group-text border-dark bg-danger text-light" id='time'>Time</span>
                ...
                <div className='input-group col-md-4 col-sm-12'>
                    ...
                    <button type="submit" className="btn btn-danger col-md-2">SUBMIT</button>
                </div>
            </div>
        </form>
    )
